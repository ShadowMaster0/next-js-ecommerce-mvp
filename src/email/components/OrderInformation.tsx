...
const dataFormatter = new Intl.DateTimeFormat("en-US", { dateStyle: "medium" });
...
export function OrderInformation({
  ...
  return (
    <>
      ...
      <Section
        className="border border-solid border-gray-500 rounded-lg p-4 md:p-6 
      my-4"
      >
        <Img
          width="100%"
        ...
        <Row>
          <Column>
            <Text className="tex-gray-500 mb-0">{product.description}</Text>
          </Column>
        </Row>
      </Section>
    </>
